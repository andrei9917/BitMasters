...
public class rockPicker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rock_picker);
        Toolbar toolbar = findViewById(R.id.toolbarRock);
        ...
        arrayList.add(R.id.imageRock1);
        arrayList.add(R.id.imageRock2);
        arrayList.add(R.id.imageRock3);
        arrayList.add(R.id.imageRock4);
        arrayList.add(R.id.imageRock5);
        arrayList.add(R.id.imageRock6);
